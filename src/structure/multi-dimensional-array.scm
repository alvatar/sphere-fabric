        ...
        (if (vector? x)
            ...
            (if (integer? x)
                ...
                (if (array:array? x)
                    ...
                    (error "array-set!: not an index object")))))
    (if (null? xs)
        ((cdr (array:index a)) (array:vector a) x)
        (if (vector? x)
            (vector-set!
             (array:vector a)
             (array:index/vector
             ...
             (car xs))
            (if (integer? x)
                (apply (cdr (array:index a)) (array:vector a) x xs)
                (if (array:array? x)
                    (vector-set!
                     (array:vector a)
                     (array:index/array
