...
(define-record-type array-type
  ...
  (offset internal-array:offset)
  (store internal-array:store))
...
(define (array:dimensions array)
  (cond ((vector? array) (list (vector-length array)))
        ...
        (else (internal-array:dimensions array))))

(define (array:scales array)
  (cond ((vector? array) '(1))
        ((string? array) '(1))
        (else (internal-array:scales array))))

(define (array:offset array)
  (cond ((vector? array) 0)
        ((string? array) 0)
        (else (internal-array:offset array))))

(define (array:store array)
  (cond ((vector? array) array)
        ((string? array) array)
        (else (internal-array:store array))))
...
;;@end example
(define (array:equal? obj1 obj2)
  (cond ((eqv? obj1 obj2) #t)
        ((or (pair? obj1) (pair? obj2))
         (and (pair? obj1) (pair? obj2)
              (array:equal? (car obj1) (car obj2))
              (array:equal? (cdr obj1) (cdr obj2))))
        ((or (string? obj1) (string? obj2))
         (and (string? obj1) (string? obj2)
              (string=? obj1 obj2)))
        ((or (vector? obj1) (vector? obj2))
         (and (vector? obj1) (vector? obj2)
              (array:equal? (vector-length obj1) (vector-length obj2))
              (do ((idx (+ -1 (vector-length obj1)) (+ -1 idx)))
                  ((or (negative? idx)
                       (not (array:equal? (vector-ref obj1 idx)
                                    (vector-ref obj2 idx))))
                   (negative? idx)))))
        ((or (array? obj1) (array? obj2))
         (and (array? obj1) (array? obj2)
              (array:equal? (array:dimensions obj1) (array:dimensions obj2))
              (array:equal? (array:store obj1) (array:store obj2))))
        (else #f)))
